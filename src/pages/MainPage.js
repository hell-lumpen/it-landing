        ...
        <main className="content-wrapper" ref={mainRef}>
          ...
          <section className="content-section" id="benefits">
            <div className={"content"}>
              <p>
                Институт №8 уже свыше полувека готовит умных и талантливых профи, которые штурмуют сферу компьютерных наук и прикладной математики! Давно пора вписаться в их историю успеха!
              </p>
              <p>
                Мы - настоящие эксперты в создании и использовании математического и программного обеспечения в самых интересных областях: от вычислительных и информационных систем до интеллектуальных решений. И самое крутое, наши выпускники не просто держат в руках дипломы, они успешно применяют свои знания в авиации, космонавтике, экономике, робототехнике, экологии и еще куче других умных направлений.
              </p>
              <p>
                Мы уверены, что наш опыт и качество образования - это именно то, что поможет тебе сделать крутой взлет в карьере. А самое интересное? У нас здесь царит атмосфера молодежного вайба и увлекательного обучения. Не упусти свой шанс стать частью нашего кружка умных и креативных людей!
              </p>
              <p>
